          ...
          {total?.macros &&
            Object.keys(total.macros).map(key => (
              ...
              >
                ...
                <div className="absolute top-0 left-0 bg-foreground text-background w-full h-full text-wrap opacity-0 hover:opacity-80 active:opacity-80 rounded-lg flex flex-col justify-center items-center p-2">
