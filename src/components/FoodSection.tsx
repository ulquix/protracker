        ...
        <div key={item.id} className="py-5 w-3xl px-5   bg-card rounded-2xl border-2 border-foreground dark:shadow-(--shadow-dark) shadow-(--shadow-bg) transition-all duration-150 ">
            ...
            <h1 className="text-2xl font-medium">
                ...
                <div className="flex gap-2 justify-center items-center">
                    ...
                    <span className="cursor-pointer" onClick={()=>remove(item.id)}>

                    <svg width="40px" height="40px" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" fill="oklch(0.7049 0.1867 47.6044)">
